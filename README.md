...
| **專案雷達 + 競品分析** | 根據技術訊號生成開源/閉源軟體、產品、模型服務與平台雷達圖，點選項目可進行企業案例查找與競品分析 |
| **方法雷達** | 根據技術訊號生成方法論、演算法、架構模式與工程實踐雷達圖 |
...
**雷達功能**使用建議：輸入較具體的技術領域，例如：
- `AI on K8s`、`LLM inference`、`vector database`、`platform engineering`

**專案雷達**聚焦開源/閉源軟體、產品、平台與模型服務；選擇項目後可進一步執行**競品分析**，產生競品比較表與選型建議。

**方法雷達**聚焦方法論、演算法、架構模式與工程實踐，不會查找企業案例或執行競品分析。
